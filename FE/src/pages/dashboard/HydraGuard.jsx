...
import AnimationTextHydraGuard from '../animations/AnimationTextHydraGuard';
...
const NotebookRunner = () => {
  ...
  const runNotebook = () => {
    ...
    fetch('http://localhost:5000/run-notebook', {
      ...
      body: JSON.stringify({ fileName: 'component_04.ipynb' }), // Send the file name
    })
